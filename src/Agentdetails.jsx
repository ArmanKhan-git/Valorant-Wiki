...
const agent = agentData.find(
  ...
  return (<>
      ...
      <div className='container relative  pl-2 max-w-full  overflow-x-hidden'>
      ...
      <div className="agentabilities z-10 w-full">
        ...
        (agent.abilities.map((ability,index)=>{
            ...
            return(
                ...
                <div key={index}>
                    ...
                    <img className=' max-w-20' src={ability.abimg} alt="" />
                    </div>
                    <div>
        ...
        <p className='text-gray-400 font-bold lg:m-40 text-9xl'>No Data Found About the Agent</p>
    )}
      </div>
    </div>
    </>
